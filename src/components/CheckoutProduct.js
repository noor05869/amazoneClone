        ...
        >
          ...
          >
            <div className="flex md:flex-row flex-col justify-end" id="cart">
              ...
              {items.length > 0 ? (
                <div className=" flex sm:w-2 xl:w-1/2 md:w-1/3 xl:w-1/4 w-full bg-gray-100 h-full">
                    ...
                    <div>
                      ...
                      <div className="mt-6">
                        <button
                          ...
                          }  border-gray-800  rounded  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 text-white`}
                        >
                          {!session
                            ? "sign in to checkout"
                            : "proceed to checkout"}
